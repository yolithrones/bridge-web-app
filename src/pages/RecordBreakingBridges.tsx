...
const RecordBreakingBridges: React.FC = () => {
  const [filteredBridges, setFilteredBridges] = useState(bridges.filter(bridge => bridge.category === 'record-breaking'));
  ...
  return <div className="container mx-auto px-4 py-8">
      <div className="max-w-4xl mx-auto mb-8">
        ...
        <p className="text-lg text-gray-600 text-center">
          Explore the longest, tallest, and most extraordinary bridges that have
          set world records in engineering.
        </p>
      </div>
      <FilterSystem onFilterChange={handleFilterChange} initialCategory="record-breaking" />
...
export default RecordBreakingBridges;
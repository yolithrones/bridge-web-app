...
const IconicBridges: React.FC = () => {
  const [filteredBridges, setFilteredBridges] = useState(bridges.filter(bridge => bridge.category === 'iconic'));
  ...
  return <div className="container mx-auto px-4 py-8">
      <div className="max-w-4xl mx-auto mb-8">
        <h1 className="text-3xl font-bold mb-4 text-center">Iconic Bridges</h1>
        <p className="text-lg text-gray-600 text-center">
          Discover famous bridges that have become cultural landmarks and
          symbols of their cities.
        </p>
      </div>
      <FilterSystem onFilterChange={handleFilterChange} initialCategory="iconic" />

...
const ModernBridges: React.FC = () => {
  const [filteredBridges, setFilteredBridges] = useState(bridges.filter(bridge => bridge.category === 'modern'));
  ...
  return <div className="container mx-auto px-4 py-8">
      <div className="max-w-4xl mx-auto mb-8">
        <h1 className="text-3xl font-bold mb-4 text-center">Modern Bridges</h1>
        <p className="text-lg text-gray-600 text-center">
          Explore contemporary bridge designs that showcase the latest
          innovations in engineering and architecture.
        </p>
      </div>
      <FilterSystem onFilterChange={handleFilterChange} initialCategory="modern" />
